...
public class RealtimeSegmentImpl implements RealtimeSegment {
  ...
  public void setSegmentPartitionConfig(SegmentPartitionConfig segmentPartitionConfig) {
    ...
    Map<String, ColumnPartitionConfig> map = segmentPartitionConfig.getColumnPartitionMap();
    for (String column : map.keySet()) {
      dictionaryMap.get(column).setPartitioner(column, segmentPartitionConfig);
    }
